...
ggplot(conteo_carreras, aes(x = "", y = n, fill = carrera)) +
  ...
  coord_polar(theta = "y") +
  scale_fill_manual(values = c(c21, c31, c11)) +
  labs(
...
|:--|:--|:--|:--|
| `asignatura` | Nombre de la asignatura | Cualitativo nominal | Análisis |
| `grupo` | Grupo académico | Cualitativo nominal | Análisis |
| `id_curso` | Identificador institucional del curso | Identificador | Control |
