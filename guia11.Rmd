...
#### Población: 
población de la cual se ha recogido la información

 <br/>  <br/> 
 
#### Tamaño de la muestra: 
número de observaciones recogidas en la base de datos

 <br/>  <br/> 
 
#### Instrumento de recolección: 
forma en que se recoge la información - puede ser implícito que se trata de un instrumento como encuesta, planilla, formulario

 <br/>  <br/> 
 
#### Ubicación espacio-temporal: 
lugar y tiempo en el que se recoge la información

 <br/>  <br/> 
 
#### Unidad estadística: 
persona u objeto del cual se obtiene la información
