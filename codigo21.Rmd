...
**Experimento aleatorio** se puede definir como una acción que podemos repetir en iguales condiciones muchas veces y cuyo resultado no conocemos anticipadamente
...
```{r}
set.seed(1234)
sample(c(1,2,3),20,rep=T,prob=c(3,5,4))
```

La misma simulación con palabras

```{r}
sample(c("Blanca","Roja","Azul"),20,rep=T,prob=c(3,5,4))
```
