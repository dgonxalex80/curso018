...
x=1:6
fx=rep(1,6)/6
plot(x,fx,pch=19, ylim=c(0,0.18), las=1, xlab="puntos", ylab="f(x)", col=c00)
lines(x, fx, type="h", col="#F1F1F1", lty=3)
...
fx=rep(1,6)/6
Fx=cumsum(fx)
plot(x,Fx, las=1, ylab="F(x)", xlab="puntos",pch=19, ylim=c(0,1), col=c00)
lines(x, Fx, type="s", col="#F1F1F1")
grid()
```
...
x=0:20
fx=choose(20,x)*0.70^x*0.30^(20-x)
plot(x,fx, las=1, ylab="f(x)", xlab="número personas que asisten", pch=19, col=c00)
lines(x, fx, type="h", col= "#F1F1F1")
```
<br/>
...
fx=choose(20,x)*0.70^x*0.30^(20-x)
Fx=cumsum(fx)
plot(x,Fx, las=1, ylab="F(x)", xlab="número personas que asisten",pch=19, ylim=c(0,1), col=c00)
lines(x, Fx, type="s", col="#F1F1F1")
grid()
