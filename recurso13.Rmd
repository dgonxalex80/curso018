...
barplot(ev, col=paleta_azul[1:5], main = "Evaluación proceso de inducción")
```
...
### Segundo paso : 
#### Declarar la base de datos y las varibles
...
campanas <- tibble(
  ...
  ventas = c(98, 106, 140, 111, 150, 132, 148, 138, 150, 207, 183, 215),
...
### Cuarto paso : 
#### Agregar caracteristicas adicionales
...
### Sexto paso : 
Agregar títilo,  etiquetas a los ejes  leyenda aclararoria
...
ggplot(camp, aes(x = inversion, y = ventas)) +
  geom_point(color = "#245B89", size = 2, alpha = 0.7) +
  geom_smooth(method = "lm", se = FALSE, color = "#3B9AC4", linetype = "dashed") +
  labs(
